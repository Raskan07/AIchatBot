...
const AiResponse = ({index,message,aiAvatar}:any) => {
  return (
    <View key={index} style={{width:"100%",alignItems:"flex-start",justifyContent:"flex-end",flexDirection:"row"}}>
        <View
          key={index} style={{margin:5,width:"70%",alignItems:"flex-end",justifyContent:"flex-end",padding:10,overflow:"hidden",borderRadius:15,backgroundColor:"#10b981"}}>
            <Text style={{color:"#fff",fontSize:15,textTransform:"capitalize",textAlign:"left"}}>{message}</Text>
        </View>
